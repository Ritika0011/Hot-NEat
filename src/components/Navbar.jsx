        ...
        <header className='w-full fixed z-10 bg-black opacity-90'>
            <nav className='flex w-full py-2 md:py-3 px-4 md:px-20 items-center justify-between'>
                ...
                <ul className='hidden md:flex text-white gap-6'>
                    <li>
                        <a className='hover:bg-red-200 rounded-full min-w-[200px] border border-black'href="/">Home</a>
                    </li>
                    <li>
                        <a className='hover:bg-red-200 rounded-full min-w-[200px] border border-black' href="/#recipes">Food</a>
                    </li>
                    {/* <li>
                        <a className='hover:bg-red-200 rounded-full min-w-[130px] border border-black' href="/favorites">Favorites</a>
                    </li> */}
                </ul>
